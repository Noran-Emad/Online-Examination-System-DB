...
INSERT INTO branch (branchname, branchaddress, branchphone) 
VALUES 
('Smart village', 'smart Village building B148 - 28 Km by Cairo / Alexandria Desert road- 6 October', '01234567890'),
('Alexandria', 'Mahmoud Saeed Street - Al Shuhada Square - Post Authority Building - 10th Floor', '01254568749'),
('Ismailia', 'El Sheikh Zayed, Ismailia 3, Ismailia Governorate', '01234597890'),
('Minya', 'Minia University next to the ring road gate', '01228567890'),
('Menoufia', 'Shebin El Kom . University stadium street, behind the military hospital, the institute has a private entrance next to the public service center of Menoufia University', '01234587890');
go


-- Insert data into department table for each branch ID from 1 to 5
INSERT INTO department (deptname, deptmanager) 
VALUES 
('Software Engineering Department', NULL),
('Computer Science Department', NULL),
('Information Systems Department', NULL),
('Networking Department', NULL),
('Cybersecurity Department', NULL),
('Data Science Department', NULL),
('Artificial Intelligence Department', NULL),
('Web Development Department', NULL),
('Mobile Application Development Department', NULL),
('Multimedia and Graphic Design Department', NULL)
go
...
INSERT INTO instructors (instfname, instlname, instaddress, instphone, deptid, branchid, instHireDate)
VALUES
-- Instructor 1
('Ahmed', 'Ali', 'Cairo, Egypt', '01012345678', 1, 1, '2022-01-01'),
-- Instructor 2
('Mohamed', 'Ibrahim', 'Alexandria, Egypt', '01023456789', 3, 1, '2022-02-01'),
-- Instructor 3
('Fatma', 'Hassan', 'Ismailia, Egypt', '01034567890', 5, 1, '2022-03-01'),
-- Instructor 4
('Sara', 'Ahmed', 'Cairo, Egypt', '01045678901', 2, 2, '2022-04-01'),
-- Instructor 5
('Hassan', 'Mohamed', 'Alexandria, Egypt', '01056789012', 4, 2, '2022-05-01'),
-- Instructor 6
('Nour', 'Elsayed', 'Ismailia, Egypt', '01067890123', 1, 3, '2022-06-01'),
-- Instructor 7
('Ali', 'Hassan', 'Cairo, Egypt', '01078901234', 2, 3, '2022-07-01'),
-- Instructor 8
('Youssef', 'Abdelrahman', 'Alexandria, Egypt', '01089012345', 4, 3, '2022-08-01'),
-- Instructor 9
('Amira', 'Osman', 'Ismailia, Egypt', '01090123456', 3, 4, '2022-09-01'),
-- Instructor 10
('Omar', 'Mahmoud', 'Cairo, Egypt', '01001234567', 5, 4, '2022-10-01'),
-- Instructor 11
('Dina', 'Hamed', 'Alexandria, Egypt', '01012345678', 1, 5, '2022-11-01'),
-- Instructor 12
('Ahmed', 'Khaled', 'Ismailia, Egypt', '01023456789', 4, 5, '2022-12-01');
go
...
INSERT INTO course (coursename, courseDuration)
VALUES
('Introduction to Programming', 10),
('Database Management Systems', 12),
('Web Development Fundamentals', 8),
('Network Security', 10),
('Artificial Intelligence', 14),
('Data Science Essentials', 12),
('Cybersecurity Fundamentals', 8),
('Mobile App Development', 10),
('Software Engineering Principles', 12),
...
INSERT INTO student (studfname, studlname, studphone, studaddress, studleader, branchid, deptid)
VALUES 
('Ahmed', 'Ali', '01012345678', 'Cairo, Egypt', NULL, 1, 1),
('Fatma', 'Hassan', '01123456789', 'Giza, Egypt', 1, 1, 3),
('Mariam', 'Salem', '01065432109', 'Port Said, Egypt', 2, 1, 5),
('Nour', 'Ahmed', '01276543210', 'Suez, Egypt', NULL, 3, 1),
('Omar', 'Abdelhameed', '01187654321', 'Aswan, Egypt', 3, 2, 4),
('Aya', 'Mahmoud', '01234567890', 'Alexandria, Egypt', 4, 3, 1),
('Ali', 'Khaled', '01154321098', 'Hurghada, Egypt', NULL, 2, 4),
('Sara', 'Mohamed', '01243210987', 'Sharm El Sheikh, Egypt', 5, 3, 4),
('Hassan', 'Amr', '01032109876', 'Dahab, Egypt', 1, 3, 2),
('Yasmine', 'Ezzat', '01121098765', 'Marsa Alam, Egypt', 2, 4, 5),
('Ahmed', 'Fathi', '01210987654', 'Siwa Oasis, Egypt', NULL, 5, 5),
('Nada', 'Osman', '01009876543', 'Fayoum, Egypt', 5, 5, 1);
go


INSERT INTO InstructorStudentCourses (courseid, Studentid, Instructorid)
VALUES
    -- First 10 rows
    ...
    (6, 7, 6), (7, 8, 7), (8, 9, 8), (9, 10, 9), (10, 1, 10),
    -- Third 10 rows
    (1, 3, 1), (2, 4, 2), (3, 5, 3), (4, 6, 4), (5, 7, 5),
    (6, 8, 6), (7, 9, 7), (8, 10, 8), (9, 1, 9), (10, 2, 10);
